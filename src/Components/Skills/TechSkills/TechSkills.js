...
const TechSkills = () => {
  const images = [
    ...
    { key: "ruby", src: ruby, duration: 1.5, class: "box2" },
    { key: "html", src: html, duration: 1.5, class: "box3" },
    { key: "css", src: css, duration: 1.5, class: "box4" },
    { key: "react", src: react, duration: 1.5, class: "box5" },
    { key: "rubyonrails", src: rubyonrails, duration: 1.5, class: "box1" },
    { key: "postgresql", src: postgresql, duration: 1.5, class: "box1" },
    { key: "postman", src: postman, duration: 1.5, class: "box5" },
    { key: "jest", src: jest, duration: 1.5, class: "box4" },
    ...
    { key: "figma", src: figma, duration: 1.5, class: "box4" },
